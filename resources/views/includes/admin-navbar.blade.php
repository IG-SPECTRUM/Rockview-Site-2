				...
				@if($can_view_applicants || auth()->user()->user_type == "super admin")
					<li class="submenu">
						<a href="#" class="text-success">
							<i class="la la-users"></i> <span> Applicants </span> <!--<span class="menu-arrow"></span>-->
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<ul style="display: none;">
						<li>
							<a href="{{ route('applicants.index') }}" class="nav-link">
								<span>Successfull Application</span>
							</a>
						</li>
						<li>
							<a href="" class="nav-link">
						...
						<li>
							<a href="{{ route('applicantions-progress') }}" class="nav-link">
