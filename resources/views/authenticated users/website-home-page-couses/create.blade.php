...
@section('content')
 ...
 <div class="page-header">
        ...
        <div class="col-sm-12">
            <h3 class="page-title">
                Add Course
                <a href="{{ route('website-main-page-couses.index') }}" class="btn add-btn border-0" style="background:#006400">
                    <i class="fa fa-eye"></i>
                    view
                </a>
            </h3>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('website-main-page-couses.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @if(@session('success'))
